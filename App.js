...
function SignUpStack() {
  return (
    <Stack.Navigator initialRouteName="Timer">
        <Stack.Screen name="Productivity Timer ⏱️" component={TimerScreen} />
...
function TimerStack() {
  return (
    <Stack.Navigator initialRouteName="Timer">
      <Stack.Screen name="Productivity Timer ⏱️" component={SignUpStack} />
...
function GamesStack() {
  return (
    <Stack.Navigator initialRouteName="Games">
      ...
      <Stack.Screen name="Productivity Timer3" component={SignUpStack} />
...
function ShopStack() {
  return (
    <Stack.Navigator initialRouteName="Shop">
      ...
      <Stack.Screen name="Productivity Timer1" component={SignUpStack} />
...
function RewardsStack() {
  return (
    <Stack.Navigator initialRouteName="Rewards">
      ...
      <Stack.Screen name="Productivity Timer2" component={SignUpStack} />
  ...
  return (
    <NavigationContainer>
      <Tab.Navigator
        ...
        <Tab.Screen name="Timer" component={SignUpStack} />
